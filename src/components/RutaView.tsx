                              ...
                              <button
                                onClick={async () => {
                                  ...
                                  await enviarAccionBot(c, 'enviar_grupo_mate', {
                                    ...
                                    // 🖼️ F3.62 — mismo fix que ya tienen los botones
                                    // ⚡ del chat (F3.59): el reporte del modal va
                                    // CON imagen; los mensajes del chat siguen
                                    // limpios. El bot v1.6 (f3.60) ya lo respeta.
                                    conImagen: true,
                                  });
