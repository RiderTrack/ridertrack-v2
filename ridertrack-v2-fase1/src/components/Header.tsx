      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <div className="flex items-center gap-2.5 pl-2 border-l border-slate-800">
          <img
            ...
            alt="Alejandro Ruiz"
            className="w-8 h-8 rounded-xl object-cover ring-2 ring-blue-500/50 shadow-md"
          />
          <div className="hidden xl:flex flex-col text-left">
            <span className="text-xs font-bold text-white leading-none">Alejandro Ruiz</span>
